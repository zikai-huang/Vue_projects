<template>
  <div id="app">
    ...
    <ul class="stack-large" id="todo">
      <li v-for="item in show" :key="item.id">
        <todo-item v-bind="item"
          @checkbox-changed="updateDoneStatus(item.id)"
          @item-edited="itemEdit(item.id, $event)"
          @item-deleteed="deleteItem(item.id)">
        </todo-item>
      </li>
    </ul>
    <check-all @show-all="show_all" @delete-all="delete_all"></check-all>
    <span class="items_count" ref="listsummary">
